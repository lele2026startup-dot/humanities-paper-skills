...
- 默认 12000 字：引言 500-800、主体 3 大标题×3 小标题=9 部分每部分约 1200、结语约 500（可选）
- 结构规律来自《马克思主义研究》25-26 年 200+ 篇样本统计：3 大标题最主流（约54%），4 大次之（31%），5 大（11%）；约 73% 无独立结语
- 大标题起法：递进式排比（最常见）、概念-展开式（冒号式）、从X到Y式、直接陈述式；附6个二级方向各1个典型样本
- 小标题起法：冒号式拆解、从X到Y式；小标题之间要有内在递进关系
- 引言内部：问题缘起→学界综述→核心论点→论述路径
- 结语内部（如需）：总结→局限与后续空间→发展方向
